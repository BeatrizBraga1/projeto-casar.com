...
const Navbar: React.FC = () => {
    ...
    return (
        <div className="flex items-center justify-between border-b-0 sm:border-b sm:border-gray-300">
            <div className="flex items-center w-full sm:w-1/2 p-[20px] relative">
            ...
            <div className="hidden sm:flex items-center justify-end w-1/2 pr-[20px]">
